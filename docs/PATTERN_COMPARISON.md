...
| **Breakout from Range** | Price breaks above resistance | - Partially: Volatility patterns | Detects consolidation, not breakout direction |
...
| **Bollinger Squeeze** | Bands narrowing before breakout | - Partially: Low volatility | Detects consolidation periods |
